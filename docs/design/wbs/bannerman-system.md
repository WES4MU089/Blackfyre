...
Base mustering delay (before modifiers) depends on holding size (type and size are independent — see holdings-system.md §2):
...
| Example Holding | Max Manpower | Garrison Reserve (20%) | Available to Muster | Loyal (110%) | Dutiful (100%) | Reluctant (85%) | Hostile (65%) |
|---|---|---|---|---|---|---|---|
| Military, Size 1 | 1,500 | 300 | 1,200 | 1,200 (cap) | 1,200 | 1,020 | 780 |
| Hybrid, Size 2 | 4,000 | 800 | 3,200 | 3,200 (cap) | 3,200 | 2,720 | 2,080 |
| Civilian, Size 3 | 10,000 | 2,000 | 8,000 | 8,000 (cap) | 8,000 | 6,800 | 5,200 |

**Note:** Type and size are independent axes. Any type can be any size. The examples above show one combination each — see holdings-system.md §3 for the full manpower matrix.
...
The **player lord controls the War Council entirely.** NPC bannermen do not fill War Council seats. The player assigns their own characters (player characters, other players, or retainers) to all nine seats. NPC lords who march with the army contribute their troops but do not occupy War Council positions.

This means the quality of a player's War Council depends on the characters they personally recruit and develop — not on how many NPC bannermen answer the call.

### 6.3 What Happens to NPC Troops If the Player Lord Is Incapacitated?

If the player lord (or Warlord) is incapacitated (injured, knocked unconscious) or captured during battle:

1. **The army does NOT automatically shatter.** NPC contingents remain in the battle.
2. **Command succession:** If the Warlord seat is lost, the next surviving War Council member with the highest Command aptitude takes over. If no War Council members remain able to command, the army operates with no Warlord (default Command 0 = 0 dice, no damage dealt) and will likely rout.
3. **Morale impact:** -3 morale (the lord falling is devastating to troops, but the army survives if leadership transitions).
4. **War Council members remain** in their seats — they are the player's own characters/retainers, not NPC bannermen.
5. **After the battle:** NPC contingents detach and march home to their own holdings. They do not remain under the incapacitated lord's command automatically — once recovered, the lord must call banners again.

### 6.4 NPC Contingent Detachment
...
- The NPC lord acts as Warlord with their Command aptitude; remaining War Council seats are empty or filled by household retainers (typically aptitude 3-6)
...
**Exception:** If an NPC lord fills the Warlord seat (e.g., command succession after the player lord is incapacitated or captured), they use a **default NPC gambit loadout:**
...
| **War Priest present** | +3 disposition bonus for same-Faith NPCs when the player's War Priest shares the NPC's Faith |
...
|---|---|---|---|---|
| Lord Karstark | +45 (Dutiful) | Dutiful | Military, Size 2 (3,000 max) | 2,400 |
| Lord Umber | +60 (Loyal) | Loyal | Military, Size 2 (3,000 max) | 2,400 |
| Lord Manderly | +25 (Dutiful) | Dutiful | Civilian, Size 2 (6,000 max) | 4,800 |
| Lord Bolton | -15 (Reluctant) | Reluctant | Hybrid, Size 2 (4,000 max) | 3,200 |
...
- Delay: Base 3 (Size 2) - 1 (Loyal) - 1 (Defense) = **1 tick**
...
|---|---|---|---|---|
| Lord Dustin | -10 (Reluctant) | Reluctant | Hybrid, Size 1 (2,000 max) | 1,600 |
| Lord Ryswell | -35 (Hostile) | Hostile | Military, Size 1 (1,500 max) | 1,200 |
| Lord Hornwood | -55 (Rebellious) | Rebellious | Civilian, Size 1 (3,000 max) | 2,400 |
...
- Delay: Base 3 (Size 2) + 1 (Reluctant) + 1 (Weak CB) + 2 (Feared) = **7 ticks**

**Lord Ryswell (Hostile + Weak CB + Feared):**
- Manpower: 65% (Hostile) × 90% (Weak CB) × 70% (Feared) = 1,200 × 0.41 = **492 men**
- Delay: Base 2 (Size 1) + 2 (Hostile) + 1 (Weak CB) + 2 (Feared) = **7 ticks**
...
- [ ] Integration with future Succession Law system (what happens to disposition when a lord is permanently incapacitated and their heir inherits?)
