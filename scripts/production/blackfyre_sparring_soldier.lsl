// Blackfyre Sparring Soldier NPC — Touch-to-interact
// Place this script inside a prim representing the Sparring Soldier NPC.
...
string NPC_TYPE  = "sparring_soldier";
string NPC_NAME  = "Ser Rodrik";
...
default
{
    ...
    http_response(key request_id, integer status, list metadata, string body)
    {
        ...
        // if (status != 200) llOwnerSay("[Sparring Soldier] HTTP error: " + (string)status + " — " + body);
    }
}
