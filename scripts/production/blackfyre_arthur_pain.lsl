// Blackfyre Ser Arthur Pain NPC — Touch-to-interact
// Place this script inside a prim representing Ser Arthur Pain.
...
string NPC_TYPE  = "arthur_pain";
string NPC_NAME  = "Ser Arthur Pain";
...
default
{
    ...
    http_response(key request_id, integer status, list metadata, string body)
    {
        ...
        // if (status != 200) llOwnerSay("[Arthur Pain] HTTP error: " + (string)status + " — " + body);
    }
}
