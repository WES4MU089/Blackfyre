// Blackfyre Royal Treasurer NPC — Touch-to-interact
// Place this script inside a prim representing the Royal Treasurer NPC.
...
string NPC_TYPE  = "royal_treasurer";
string NPC_NAME  = "The Royal Treasurer";
...
default
{
    ...
    http_response(key request_id, integer status, list metadata, string body)
    {
        ...
        // if (status != 200) llOwnerSay("[Royal Treasurer] HTTP error: " + (string)status + " — " + body);
    }
}
